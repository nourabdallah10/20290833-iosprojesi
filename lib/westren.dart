...
import 'package:newprojectflutter/french.dart';
import 'package:newprojectflutter/listmenufood.dart';
import 'package:newprojectflutter/recipes.dart';
import 'package:url_launcher/url_launcher.dart';
import './Rglobals.dart' as Rglobals;


class westren extends StatefulWidget {
   const westren({super.key});

  @override
  State<westren> createState() => _westren();
}

class _westren extends State<westren> {
  @override
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                          onTap: () {
                            ...
                            Rglobals.Photo = 'images/risotto.jpg';
                            Navigator.push(
                                  context,
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                          onTap: () {
                            ...
                            Rglobals.Photo = 'images/pasta.jpg';
                            Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const recipes()),
                                );
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                          onTap: () {
                            ...
                            Rglobals.Photo = 'images/calzone.jpg';
                             Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const recipes()),
                                );
                          ...
                          child: Row(
                            ...
                            children: [
                              Ink.image(
                                image: AssetImage('images/calzone.jpg'),
                                width: 200,
                                height: 120,
                                fit: BoxFit.cover,
                              ),
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                          onTap: () {
                            ...
                            Rglobals.Photo = 'images/pizza.webp';
                            Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const recipes()),
                                );
